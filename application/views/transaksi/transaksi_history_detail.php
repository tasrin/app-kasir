	...
	echo "
		<table class='info_pelanggan'>
			<tr>
				...
				<td>:</td>
				<td>".ucwords($master->nama_pelanggan)."</td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td>:</td>
				<td>".preg_replace("/\r\n|\r|\n/",'<br />', ucwords($master->alamat_pelanggan))."</td>
			</tr>
			<tr>
				<td>Telp. / HP</td>
				<td>:</td>
			...
			<tr>
				...
				<td>:</td>
				<td>".preg_replace("/\r\n|\r|\n/",'<br />', ucwords($master->info_pelanggan))."</td>
			</tr>	
		</table>
		<hr />
	";
...
<table id="my-grid" class="table tabel-transaksi" style='margin-bottom: 0px; margin-top:0px;'>
	<thead>
		<tr>
			<th>#</th>
			<th>Kode Barang</th>
